...
m_1_inl = (Calib_inv * [m_1, ones(length(m_1),1)]')';
m_2_inl = (Calib_inv * [m_2, ones(length(m_2),1)]')';

% Use algorithm.

E = Helmke_Huber_alg(InGuess, 0.000001, m_1_inl, m_2_inl);
time_helmke = toc;

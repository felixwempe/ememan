function [ U_est, V_est, numb_iter_used ] = Helmke_Huber_alg( U_init, V_init,...
    acc, m_1, m_2, delta, max_it )
...
grad = (numb_good/numb_points)* J' * M_1 * E_k(:) + (delta/numb_points) * ...
    J' * M_2' * Sign;
...
for i=1:max_it
    ...
    H = (numb_good/numb_points)*(H_hat+H_til_1)+(delta/numb_points)*H_til_2;
